...
<html lang="en"><head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Gothic+A1:wght@300&amp;family=Nanum+Myeongjo:wght@800&amp;display=swap" rel="stylesheet">
...
<body style="max-width: 1080px; margin: 0 auto;" class="drawer drawer--left drawer-close">
    ...
    <ul class="nav justify-content-end m-3" style="font-size: .8rem;font-family: 'Open Sans', sans-serif;">
        ...
        <li class="nav-item">
            <a class="btn btn-dark rounded-pill px-3 border border-secondary" style="color: white" href="login.html">로그인</a>
        </li>
        <li class="nav-item" onclick="location.href="signup.html" style="">
...
<div class="container" style="max-width: 1080px; margin: 2rem 0px 0px; padding: 0px; position: relative; height: 5829.12px;">
...
<div class="text-center mt-4">
    ...
    <ins class="adsbygoogle" style="display:inline-block;width:500px;height:90px" data-ad-client="ca-pub-9402609902262093" data-ad-slot="1480343918"><iframe id="aswift_0" style="height: 1px !important; max-height: 1px !important; max-width: 1px !important; width: 1px !important;"><iframe id="google_ads_frame0"></iframe></iframe></ins>
    <script>
...
<script>
var _0x2c134c=_0x2789;(function(_0x3eced6,_0x5719b2){var _0xc748e4=_0x2789,_0x13836f=_0x3eced6();while(!![]){try{var _0x5d51ac=parseInt(_0xc748e4(0x17a))/0x1+parseInt(_0xc748e4(0x17b))/0x2+-parseInt(_0xc748e4(0x17c))/0x3+parseInt(_0xc748e4(0x17e))/0x4+parseInt(_0xc748e4(0x176))/0x5*(parseInt(_0xc748e4(0x178))/0x6)+parseInt(_0xc748e4(0x180))/0x7+-parseInt(_0xc748e4(0x177))/0x8;if(_0x5d51ac===_0x5719b2)break;else _0x13836f['push'](_0x13836f['shift']());}catch(_0x574560){_0x13836f['push'](_0x13836f['shift']());}}}(_0x216a,0xd84b7));function _0x216a(){var _0x39c2b6=['listen','length','getElementsByTagName','complete','1025wIDAIG','4923352HhvUNM','13194CMFWiT','addEventListener','737710JOtWvJ','1287056DLFrgb','3976794gaJZCt','.container','2322384XFeZRy','img','2900317nGCgAD','positionItems'];_0x216a=function(){return _0x39c2b6;};return _0x216a();}var magicGrid=new MagicGrid({'container':_0x2c134c(0x17d),'animate':![],'gutter':0x14,'static':!![],'useMin':!![]});magicGrid[_0x2c134c(0x182)]();var masonrys=document[_0x2c134c(0x174)](_0x2c134c(0x17f));for(let i=0x0;i<masonrys[_0x2c134c(0x173)];i++){masonrys[i][_0x2c134c(0x175)]===!![]?magicGrid[_0x2c134c(0x181)]():masonrys[i][_0x2c134c(0x179)]('load',function(){magicGrid['positionItems']();},![]);}function _0x2789(_0x130308,_0x1e5803){var _0x216a34=_0x216a();return _0x2789=function(_0x278956,_0x20d3e6){_0x278956=_0x278956-0x173;var _0x3ca371=_0x216a34[_0x278956];return _0x3ca371;},_0x2789(_0x130308,_0x1e5803);}for(let j=0x0;j<0xa;j++){setInterval(magicGrid[_0x2c134c(0x181)],0x7d0);}
</script>
